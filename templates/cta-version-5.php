	...
	<div class="pure-u-1 pure-u-md-1-3 mxw-540">
		<div class="bg-center bg-cover bg-padding" style="background-image: url(<?php echo $a['background']; ?>);">
			<div class="pure-card">
				...
				<p class="pure-text-bolder">10 minutos <span class="pure-text-accent-color">gratis</span> en tu consulta de 30 minutos</p>
				<h2 class="pure-text-accent-color pure-text-bolder">Estoy disponible</h2>
			</div>
		</div><!-- .bg-cover -->
