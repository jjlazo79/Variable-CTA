...
/**
 * Template call to action version 5
 *
	...
	<div class="pure-u-1 pure-u-md-1-2 pure-u-lg-10-24 pure-u-xl-1-3">
		<div class="bg-center bg-cover bg-padding" style="background-image: url(<?php echo $a['background']; ?>);">
			<div class="pure-card">
				...
				<h5 class="pure-text-12 pure-text-bolder">10 minutos <span class="pure-text-accent-color">gratis</span> en tu consulta de 30 minutos</h5>
				<h2 class="pure-text-18 pure-text-accent-color pure-text-bolder">Estoy disponible</h2>
			</div>
		</div><!-- .bg-cover -->
